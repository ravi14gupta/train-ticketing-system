...
const (
	...
	TicketService_GetSectionUsers_FullMethodName = "/ticket.TicketService/GetSectionUsers"
...
type TicketServiceClient interface {
	...
	GetSectionUsers(ctx context.Context, in *SectionRequest, opts ...grpc.CallOption) (*SectionResponse, error)
...
func (c *ticketServiceClient) GetSectionUsers(ctx context.Context, in *SectionRequest, opts ...grpc.CallOption) (*SectionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SectionResponse)
	err := c.cc.Invoke(ctx, TicketService_GetSectionUsers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TicketServiceServer interface {
	...
	GetSectionUsers(context.Context, *SectionRequest) (*SectionResponse, error)
...
func (UnimplementedTicketServiceServer) GetSectionUsers(context.Context, *SectionRequest) (*SectionResponse, error) {
...
func _TicketService_GetSectionUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TicketServiceServer).GetSectionUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TicketService_GetSectionUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TicketServiceServer).GetSectionUsers(ctx, req.(*SectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TicketService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TicketService_GetSectionUsers_Handler,
		},
		{
